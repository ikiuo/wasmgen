...
namespace wasmgen
{
    namespace Instruction
    {
        ...
        const Data table {
            ...
            {"elem.drop",{Operation(0,0,0,0,0,0),Operand(1,18,0,0),3,{252,13,256}}},
            ...
            {"table.fill",{Operation(3,1,7,1,0,0),Operand(1,21,0,0),3,{252,17,256}}},
            {"memory.size",{Operation(0,0,0,0,1,0),Operand(0,0,0,0),2,{63,0}}},
            {"memory.grow",{Operation(1,1,0,0,1,0),Operand(0,0,0,0),2,{64,0}}},
            {"memory.init",{Operation(3,1,1,1,0,0),Operand(1,14,0,0),4,{252,8,256,0}}},
            ...
            {"v128.load8_lane",{Operation(2,1,5,0,5,0),Operand(2,28,11,0),4,{253,84,256,257}}},
            {"v128.load16_lane",{Operation(2,1,5,0,5,0),Operand(2,29,11,0),4,{253,85,256,257}}},
            {"v128.load32_lane",{Operation(2,1,5,0,5,0),Operand(2,30,11,0),4,{253,86,256,257}}},
            {"v128.load64_lane",{Operation(2,1,5,0,5,0),Operand(2,31,11,0),4,{253,87,256,257}}},
            {"v128.store8_lane",{Operation(2,1,5,0,0,0),Operand(2,28,11,0),4,{253,88,256,257}}},
            {"v128.store16_lane",{Operation(2,1,5,0,0,0),Operand(2,29,11,0),4,{253,89,256,257}}},
            {"v128.store32_lane",{Operation(2,1,5,0,0,0),Operand(2,30,11,0),4,{253,90,256,257}}},
            {"v128.store64_lane",{Operation(2,1,5,0,0,0),Operand(2,31,11,0),4,{253,91,256,257}}},
            ...
            {"ref.null",{Operation(0,0,0,0,7,0),Operand(1,25,0,0),2,{208,256}}},
            {"ref.is_null",{Operation(1,7,0,0,1,0),Operand(0,0,0,0),1,{209}}},
